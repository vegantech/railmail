...
Add this to your Gemfile:
  ...
  gem 'railmail', "~> 3.0.0", :git => "https://github.com/zonecheung/railmail.git"
...
And the last, add the /railmail to your routes.rb:

  get "/railmail"          => "railmail#index", :as => "railmail_index"
  get "/railmail/raw/:id"  => "railmail#raw",   :as => "railmail_raw"
  get "/railmail/part/:id" => "railmail#part",  :as => "railmail_part"
